...
<div class="category-grid">
  ...
  <a href="sbcs-mini-pcs/" class="category-card" style="--card-accent:#8b5cf6;">
    ...
    <div class="card-count">💻 3 products &nbsp;·&nbsp; SBCs, Edge AI, Industrial</div>
  </a>
...
## Why Elephantronics documentation?

<div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin: 1.5rem 0;">

<div style="text-align:center; padding: 1.5rem 1rem;">
  <div style="font-size:2rem; margin-bottom:.5rem;">🔍</div>
  <strong>Instant Search</strong><br>
  <small style="color:var(--md-default-fg-color--light)">Find any topic across all products in seconds</small>
</div>

<div style="text-align:center; padding: 1.5rem 1rem;">
  <div style="font-size:2rem; margin-bottom:.5rem;">📱</div>
  <strong>Mobile-Friendly</strong><br>
  <small style="color:var(--md-default-fg-color--light)">Read guides on-site from any device</small>
</div>

<div style="text-align:center; padding: 1.5rem 1rem;">
  <div style="font-size:2rem; margin-bottom:.5rem;">🌙</div>
  <strong>Dark Mode</strong><br>
  <small style="color:var(--md-default-fg-color--light)">Easy on the eyes during late-night installs</small>
</div>

<div style="text-align:center; padding: 1.5rem 1rem;">
  <div style="font-size:2rem; margin-bottom:.5rem;">📋</div>
  <strong>Copy Code</strong><br>
  <small style="color:var(--md-default-fg-color--light)">One-click copy on every code snippet</small>
</div>

</div>

!!! tip "New to Elephantronics?"
    Start with our [Solar System Guides](solar/) if you're setting up a new installation, or jump straight to your product category above.
